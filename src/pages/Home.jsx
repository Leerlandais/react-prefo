    ...
    return (
        <div id="intro">
            <p> Comme je l'ai peut-être mentionné à plusieurs reprises, j'ai grandi avec des ordinateurs. Quand j'avais
                ...
                mises à
                niveau qui ont suivi. Je pouvais taper au clavier avant de savoir écrire en cursive. Le samedi matin, à
                6
                heures du matin, voire plus tôt, mon frère et moi nous précipitions dans le couloir parce que la
                première
                personne devant l'ordinateur était le "patron" de la journée. À 6 ans, je ne me sentais pas bien, alors
                j'ai
                pris un jour de congé de l'école. Mon père m'a demandé de taper un programme dans le <em>Commodore
                    Pet</em> et à 9h30, je l'ai appelé au travail parce que j'avais atteint la fin de l'écran et je ne
                savais
                pas quoi faire... En gros, je n'ai jamais été sans un ordinateur devant moi. Jamais.</p>

            <p>Mon premier travail avec les ordinateurs a commencé en 1997, lorsque j'ai commencé à travailler au
                Voyager
            ...
            <p>En 2000, j'étais chez <em>Compustore</em>, à Waterford, où je vendais des ordinateurs <em>Packard
                ...
                moment-là, je faisais également office de technicien de la boutique, passant mon temps à travailler sur
                les
                entrailles des machines, à les réparer, à les mettre à niveau et même à en construire une à partir de
                zéro.
            </p>

            <p>Malheureusement, <em>Compustore</em> a fermé ses portes en 2001, alors j'ai fini par travailler comme
                barman pendant quelques années, pendant lesquelles j'ai suivi un cours sur Visual Basic (c'était à
                l'époque
                avant où VB commençait à être généralement détesté), avant de décider de déménager en Belgique. Depuis
                que
            ...
            <p>Au début de l'été, un bon ami, Mark Harris, m'a parlé du CF2M et des excellents cours disponibles là-bas.
                J'ai parcouru les cours disponibles, j'ai vu celui de WebDev et le reste appartient à
                "l'histoire"...</p>
        </div>
    )
}
